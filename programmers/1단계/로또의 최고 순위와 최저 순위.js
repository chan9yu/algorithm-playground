//? 로또의 최고 순위와 최저 순위
//* 로또 6/45(이하 '로또'로 표기)는 1부터 45까지의 숫자 중 6개를
//* 찍어서 맞히는 대표적인 복권입니다.
...
function solution(lottos, win_nums) {
	...
	for (let lotto of lottos) {
		win_nums.forEach(win => win === lotto && (answerCnt += 1))
		!lotto && (zeroCnt += 1)
	}

	answer.push(7 - (answerCnt + zeroCnt) >= 7 ? 6 : 7 - (answerCnt + zeroCnt))
	answer.push(7 - answerCnt >= 7 ? 6 : 7 - answerCnt)

	return answer
}

let arr1 = [44, 1, 0, 0, 31, 25]
let arr2 = [31, 10, 45, 1, 6, 19]
console.log(solution(arr1, arr2)) //* return [3, 5]

arr1 = [0, 0, 0, 0, 0, 0]
arr2 = [38, 19, 20, 40, 15, 25]
console.log(solution(arr1, arr2)) //* return [1, 6]

arr1 = [45, 4, 35, 20, 3, 9]
arr2 = [20, 9, 3, 45, 4, 35]
console.log(solution(arr1, arr2)) //* return [1, 1]
