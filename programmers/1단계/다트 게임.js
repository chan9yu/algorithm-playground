...
function solution(dartResult) {
	...
	for (let i = 0; i < dartResult.length; i++) {
		...
		else if (dartResult[i] === 'S') cnt.push(score)
		else if (dartResult[i] === 'D') cnt.push(Math.pow(score, 2))
		else if (dartResult[i] === 'T') cnt.push(Math.pow(score, 3))
...
console.log(solution('1S2D*3T')) //* return 37
console.log(solution('1D2S#10S')) //* return 9
console.log(solution('1D2S0T')) //* return 3
console.log(solution('1S*2T*3S')) //* return 23
console.log(solution('1D#2S*3S')) //* return 5
console.log(solution('1T2D3D#')) //* return -4
console.log(solution('1D2S3T*')) //* return 59
