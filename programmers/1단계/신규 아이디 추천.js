...
//* "네오"에게 주어진 첫 업무는 새로 가입하는 유저들이 카카오 아이디 규칙에
//* 맞지 않는 아이디를 입력했을 때, 입력된 아이디와 유사하면서 규칙에 맞는
...
//* 신규 유저가 입력한 아이디가 카카오 아이디 규칙에 맞는지 검사하고
...
console.log(solution('...!@BaT#*..y.abcdefghijklm')) //* return "bat.y.abcdefghi"
console.log(solution('z-+.^.')) //* return "z--"
console.log(solution('=.=')) //* return "aaa"
console.log(solution('123_.def')) //* return "123_.def"
console.log(solution('abcdefghijklmn.p')) //* return 	"abcdefghijklmn"
